class _planets_database:
    ...
    def get_planet(self, pid):
        if pid in self.planets:
            return {'mass':self.planets[pid]['mass'], 'radius':self.planets[pid]['radius'], 'period':self.planets[pid]['period']}
        return None
    ...
    def set_planet(self, pid, inp):
        if pid not in self.planets:
            self.planets[pid] = {}
        self.planets[pid]['type'] = str(inp[1])
        self.planets[pid]['mass'] = str(inp[2])
        self.planets[pid]['radius'] = str(inp[3])
        self.planets[pid]['period'] = str(inp[4])
        self.planets[pid]['semiMajorAxis'] = str(inp[5])
        self.planets[pid]['eccentricity'] = str(inp[6])
        self.planets[pid]['periastron'] = str(inp[7])
        self.planets[pid]['longitude'] = str(inp[8])
        self.planets[pid]['ascendingNode'] = str(inp[9])
        self.planets[pid]['inclination'] = str(inp[10])
        self.planets[pid]['surfaceTemperature'] = str(inp[11])
        self.planets[pid]['age'] = str(inp[12])
        self.planets[pid]['discoveryMethod'] = str(inp[13])
        self.planets[pid]['dicoveryYear'] = str(inp[14])
        self.planets[pid]['lastUpdated'] = str(inp[15])
        self.planets[pid]['rightAscension'] = str(inp[16])
        self.planets[pid]['declination'] = str(inp[17])
        self.planets[pid]['distanceFromSun'] = str(inp[18])
        self.planets[pid]['hostStarMass'] = str(inp[19])
        self.planets[pid]['hostStarRadius'] = str(inp[20])
        self.planets[pid]['hostStarMetallicity'] = str(inp[21])
        self.planets[pid]['hostStarTemperature'] = str(inp[22])
        self.planets[pid]['hostStarAge'] = str(inp[23])
